...
(
  ...
  player3 integer NOT NULL REFERENCES u_players,
  player4 integer NOT NULL REFERENCES u_players,
  character1 integer NOT NULL REFERENCES u_characters,
  character2 integer NOT NULL REFERENCES u_characters,
  character3 integer NOT NULL REFERENCES u_characters,
  character4 integer NOT NULL REFERENCES u_characters,
  stage integer NOT NULL REFERENCES u_stages,
  winner integer NOT NULL REFERENCES u_players,
  winner2 integer NOT NULL REFERENCES u_players,
  rating1 int,
  rating2 int,
  rating3 int,
  rating4 int,
